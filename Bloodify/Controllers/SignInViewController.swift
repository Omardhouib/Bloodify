...
class SignInViewController: UIViewController {
    ...
    let URL_USER_LOGIN = "http://"+Ipaddress.phpIpAdress+"/login.php"
    ...
    override func viewDidAppear(_ animated: Bool) {
        if CheckInternet.Connection(){
            ...
            self.displayMessage1(userMessage: "Your Device is not connected with internet")
        }
